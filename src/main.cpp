...
uint256 hashGenesisBlock("0x15ac3cf8f1dbf6ed60072bcc31fd0de2b439f373816f873a704a3eeb2868db1e");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(503841062); // FliteCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FliteCoin Signed Message:\n";
...
{
    // FliteCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 12000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 840000); // FliteCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // FliteCoin: 3.5 days
static const int64 nTargetSpacing = 120; // FliteCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // FliteCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FliteCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // FliteCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2c1bb9e1837106cbe29dcd18e7625e29c9e3261962d76eaac0204b201522eb5b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Amazing!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 12000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("c3213d57294be3954fa96e0ad925c1b099b8fefb7f60c663dcca22294f5f75bb7dffcdd438a7b152a290e72d92afd059f6e40a086dfb0872b40e22d653037e95df") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1676805074;
        block.nBits    = 503841062;
        ...
        assert(block.hashMerkleRoot == uint256("0xcfe78eaec27b949a2351029c87e477fa6003a8f498fb580aabaeac51e1a478f7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // FliteCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FliteCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FliteCoinMiner : ProcessBlock, block not accepted");
    }
